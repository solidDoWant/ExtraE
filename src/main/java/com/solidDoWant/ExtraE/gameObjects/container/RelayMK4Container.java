package com.solidDoWant.ExtraE.gameObjects.container;
...
public class RelayMK4Container extends Container
{
	private RelayMK1Tile tile;
	
	public RelayMK4Container(InventoryPlayer invPlayer, RelayMK1Tile relay)
	{
		this.tile = relay;
		tile.openInventory();
